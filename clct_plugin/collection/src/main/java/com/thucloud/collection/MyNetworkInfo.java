package com.thucloud.collection;

import java.util.List;

public class MyNetworkInfo {
    public String networkType; // WiFi/2G/3G/4G/5G/unknown
    public List<WifiInfo> wifiInfo;
    public List<CellInfo> cellInfo;
    public List<SubInfo> subInfo;
    public MyNetworkInfo(String networkType, List<SubInfo> subInfo, List<CellInfo> cellInfo, List<WifiInfo> wifiInfo) {
    ...
    public static class SubInfo {
        ...
        public String isEndcAvailable;
        public String isDcNrRestricted;
        public String maxDataCalls;
        public String isNrAvailable;
        public CellInfo.CellIdentity cellIdentity;
...
//        VALUES ('e1ecc539-a567-4ed8-9bc0-d8efe3b81f51','false',     '16',           'true',    'true',         'false',      '',             '',          '',     '',     '',     '460',   '11',            '46011',            '['3']','2147483647', '4818299',   '1506',    '319', '4125',    '',       '',        '',      '',         '',      '');

        public SubInfo(int subId, String is_using) {
            this.subId = subId;
    ...
    public static class WifiInfo {
        ...
        public String wifi_type; // TRANSPORT_WIFI |
        ...
        public WifiInfo(String SSID, String BSSID, String rssi, String linkSpeed, String networkId, String frequency,
                        ...
                        String currentSecurityType, String subscriptionId, String hiddenSSID, String ScanResultLength, String wifiType) {
            this.wifi_SSID = SSID;
